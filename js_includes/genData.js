...
function ibexItem(onto,CErule){
	...
	var image = '<img src="http://i1341.photobucket.com/albums/o753/ezaroukian/33_zpsy18d3v6x.png" border="0" alt=" photo 33_zpsy18d3v6x.png"/>';//"<img src='"+onto.link+" width='480' height='360' >";//html containing ontograph link on google drive? test with http://tinyurl.com/ohleh6j
